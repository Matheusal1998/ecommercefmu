...
<ul>
    <li style="width: 100px;">
        <a  href="produtosPorCategoria.php?id_categoria=1">Notebook</a>
    </li>
    <li style="width: 100px;">
        <a  href="produtosPorCategoria.php?id_categoria=2">Celulares</a>
    </li>
    <li style="width: 100px;">
        <a  href="produtosPorCategoria.php?id_categoria=3">Drones</a>
    </li>
    <li style="width: 100px;">
        <a  href="produtosPorCategoria.php?id_categoria=4">Câmeras</a>
    </li>
    <li style="width: 100px;">
        <a href="produtosPorCategoria.php?id_categoria=5">Video-game</a>
    </li>
    <li style="width: 100px;">
        <a  href="produtosPorCategoria.php?id_categoria=6">Televisores</a>
    </li>
</ul>
</div>
